...
// Run from repo root:  node scripts/e2e/run_payout.mjs
//
...
try {
  ...
  //   NOTE: this block creates ONE real Stripe Express account. It has already
  //   been exercised once against a fresh user (none→requested observed).
